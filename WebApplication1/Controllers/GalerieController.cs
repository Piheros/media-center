...
namespace WebApplication1.Controllers
{
    ...
    public class GalerieController : Controller
    {
        ...
        public async Task<IActionResult> AddImage(int? id)
        {
            ...
            var librairie = await _context.Galerie
        ...
        /**
         * Affichage de la page d'ajout d'une nouvelle image
        */
        [HttpPost("AddImage")]
        public async Task<IActionResult> AddImage(int id, String nom, IFormFile file)
        {
